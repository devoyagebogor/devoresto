<body>
    ...
    <div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container">
                <br><br>
                <h1 class="header center white-text">Deresto Coffee & Kitchen</h1>
        ...
        <div class="parallax"><img src="<?= base_url('assets/deresto/img/uploaded/background/2-min.jpg'); ?>" alt="Unsplashed background img 1 responsive-img"></div>
    </div>
    ...
    <div class="parallax-container valign-wrapper">
        ...
        <div class="parallax"><img src="<?= base_url('assets/deresto/img/uploaded/background/12.jpg'); ?>" alt="Unsplashed background img 2"></div>
    </div>
    ...
    <div class="parallax-container valign-wrapper">
        ...
        <div class="parallax"><img src="<?= base_url('assets/deresto/img/uploaded/background/IMG_7757-min.jpg'); ?>" alt="Unsplashed background img 3"></div>
    </div>
