<body>
    ...
    <div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container">
                ...
                <div class="row center">
                    <div class="col s12">
                        <a href="<?php echo base_url('deresto/list_menu'); ?>" id="download-button" class="btn waves-effect waves-light light-green darken-4">Menu List</a>
                    </div>
                </div>
        ...
        <?php foreach ($promos as $promo) : ?>
            <div class="parallax"><img src="<?= base_url('assets/deresto/img/uploaded/background/' . $promo->img); ?>" alt="Unsplashed background img 1" class="responsive-img"></div>
        <?php endforeach; ?>
    </div>
